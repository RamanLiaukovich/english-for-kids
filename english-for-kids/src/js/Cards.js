...
const cards = [ 
  ['Action (set A)', 'Action (set B)', 'Colors', 'Abjective', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions'],
  [
    {
      word: 'cry',
      translation: 'плакать',
  ...
  [
    ...
    },
    {
      word: 'black',
      translation: 'чёрный',
      image: 'src/assets/img/black.jpg',
      audioSrc: 'src/assets/audio/black.mp3'
    },     
    {
      word: 'orange',
    ...
    }, 
    {
      ...
      audioSrc: 'src/assets/audio/purple.mp3'
    },
    {
      word: 'pink',
      translation: 'розовый',
      image: 'src/assets/img/pink.jpg',
      audioSrc: 'src/assets/audio/pink.mp3'
    },                                                           
  ],
  [
    {
